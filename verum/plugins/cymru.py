    ...
    class PluginOne(IPlugin):
        ...
        def configure(self):
            ...
            if 'Inputs' in config_options:
                ...
                return [False, 'cymru', "Takes a list of IPs and returns ASN and BGP information as networkx graph of the information.", None, cost, speed]

            if not module_import_success:
                return [False, "cymru", "Takes a list of IPs and returns ASN and BGP information as networkx graph of the information.", inputs, cost, speed]
            else:
                return [True, "cymru", "Takes a list of IPs and returns ASN and BGP information as networkx graph of the information.", inputs, cost, speed]
